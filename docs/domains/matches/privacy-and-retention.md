# Match: privacy and retention

## Responsibility

The Match context owns match context, fixtures, and analytic ownership. Commands include an accountable actor and correlation identifier; model outputs remain evidence, not final sporting or medical decisions.
