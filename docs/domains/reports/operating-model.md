# Report: operating model

## Responsibility

The Report context owns coach-facing summaries, provenance, and sign-off. Commands include an accountable actor and correlation identifier; model outputs remain evidence, not final sporting or medical decisions.
